...
_HELP = {
    'pt': (
        ...
        'com evidência.\n'
        '\n'
        '2. **Ver o que está conectado** — pergunta "o que falta?" ou "tá tudo conectado?".\n'
        '\n'
        ...
        '\n'
        '4. **Minha tropa** — manda "minha tropa" pra ver quem investiga e quem revisa '
        '(Time Codex e Time Claude se conferem). Pra trocar: "coloca o revisor no opus".\n'
        '\n'
        '5. **Correções** — saem sempre como **draft PR** pra revisão humana. '
        'Nunca faço merge.\n'
        '\n'
    ...
    'en': (
        ...
        'with evidence.\n'
        '\n'
        '2. **See what is connected** — ask "what\'s missing?" or "is everything connected?".\n'
        '\n'
        ...
        '\n'
        '4. **My squad** — send "my squad" to see who investigates and who reviews '
        '(Team Codex and Team Claude check each other). To change it: "put the reviewer on opus".\n'
        '\n'
        '5. **Fixes** — always go out as a **draft PR** for human review. '
        'I never merge.\n'
        '\n'
