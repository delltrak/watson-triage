...
code, and approve. Watson texts you within seconds that it worked, unless you
asked it for a quiet agent; there is no need to tell it.
...
to revoke them (GitHub notifies you when it does; if it could not be reached,
Watson says so, and you revoke Watson Triage yourself, below), and stops checking
issues, without reporting that as a refusal, until you ask it to connect again.
To remove Watson on GitHub's side as well, revoke Watson Triage at
